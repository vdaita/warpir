...
struct kernel_globals {    gl<bf16, -1, -1, -1, -1, st_bf<64, 64>> A;    gl<bf16, -1, -1, -1, -1, st_bf<64, 64>> B;    gl<bf16, -1, -1, -1, -1, st_bf<64, 64>> C;    int N;};
...
st_bf<64, 64> (&A) = al.allocate<st_bf<64, 64>>();
st_bf<64, 64> (&B) = al.allocate<st_bf<64, 64>>();
